...
import com.example.expenseapp.Constants
import com.example.expenseapp.ExpenseListAdapter
import com.example.expenseapp.ExpenseListViewModel
import com.example.expenseapp.databinding.FragmentAddBinding
...
class AddFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.buttonAddToShow.setOnClickListener {
            it.findNavController().navigate(R.id.action_addFragment_to_showFragment)
        }
//        val expenses = expenseListViewModel.expenses
//        val  adapter = ExpenseListAdapter(expenses)
//        adapter.setCurrentFragmentType(Constants.TYPE_SHOW)
